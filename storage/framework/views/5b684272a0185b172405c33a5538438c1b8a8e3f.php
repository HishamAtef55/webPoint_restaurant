...
<script>
    ...
    $(document).ready(function() {
        ...
        saveExpensesBtn.on('click',function() {
            $.ajax({
                url: "<?php echo e(route('inDirectCost.save')); ?>",
                method: 'post',
                data: {
                    _token,
        ...
        $(document).on('click', '.delete_expenses_name', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo e(route('inDirectCost.destroy')); ?>",
                        method: 'post',
                        data: {
                            _token,
                            id: rowId
        ...
        $(document).on('click', '.update_expenses', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('inDirectCost.update')); ?>",
                method: 'post',
                data: {
                    _token,
                    id: rowId,
        ...
        addExpensesBtn.on('click',function() {
            $.ajax({
                url: "<?php echo e(route('inDirectCost.saveInDirectValue')); ?>",
                method: 'post',
                data: {
                    _token,
        ...
        $(document).on('click', '.delete_expenses', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo e(route('inDirectCost.deleteInDirectValue')); ?>",
                        method: 'post',
                        data: {
                            _token,
                            id : rowId
...
<?php /**PATH C:\xampp\htdocs\web_point\resources\views/includes/stock/Stock_Ajax/indirect_cost.blade.php ENDPATH**/ ?>