...
$(document).ready(function(){
    ...
    $(document).on('click','#save_item',function (e)
    {
        ...
        $.ajax({
            url:"<?php echo e(route('save.item')); ?>",
            method:'post',
    ...
    $(document).on('click','#item_without',function (e)
    {
        ...
        $(".listofitem").html('');
        $.ajax({
            url:"<?php echo e(route('itemWithOutPrinter')); ?>",
            method:'post',
            data: {
                _token    : _token,
                branch   : branch,
    ...
    $(document).on('click','#update_item',function (e)
    {
        ...
        e.preventDefault();
        $.ajax({
            url:"<?php echo e(route('tableitem.action')); ?>",
            method:'post',
            enctype:"multipart/form-data",
            processData:false,
            cache : false,
    ...
    $('#item-name').keyup(function () {
        ...
        if(query != '') {
            $.ajax({
                url:"<?php echo e(route('search.item')); ?>",
                method:'post',
                data:
                {
                    _token    : _token,
    ...
    $(document).on('click','#delete_item', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url:"<?php echo e(route('del_item_action')); ?>",
                    method:'post',
                    data:
                    {
                        _token    : _token,
    ...
    $(document).on('click','#list-of-items li', function (e) {
        ...
        $.ajax({
            url:"<?php echo e(route('search.item_new_up')); ?>",
            method:'post',
            data: {
                _token    : _token,
                id_item   : id_item,
            ...
            success:function(data)
            {
                ...
                $('#item-image').html(`<label for="image" class="image" style="background-image:url(<?php echo e(URL::asset('control/images/items')); ?>/${data.items.image})"></label>`);
                $('#list-of-items').html("")

                $('#item-image').html(`<label for="image" class="image unvisibile" style="background-image:url(<?php echo e(URL::asset('control/images/items')); ?>/${data.items.image})"></label>`);
                // $('#image').onchange();
    ...
    $(document).on('click','#show_items',function (e)
    {
        ...
        $.ajax({
            url:"<?php echo e(route('show_all_item')); ?>",
            method:'post',
            data: {
                _token,
                branch,
    ...
    $(document).on('click','.updatePriceAll',function (e){
        ...
        $.ajax({
            url:"<?php echo e(route('update_item_price')); ?>",
            method:'post',
            data: {
                _token,
                itemId,
    ...
    $(document).on('click','.updateActiveAll',function (e){
        ...
        let itemId = $(this).val()
        $.ajax({
            url:"<?php echo e(route('update_item_active')); ?>",
            method:'post',
            data: {
                _token,
                itemId,
...
<?php /**PATH F:\BackEnd\htdocs\webpoint\resources\views/includes/control/item.blade.php ENDPATH**/ ?>