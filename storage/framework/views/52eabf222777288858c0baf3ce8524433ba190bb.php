    ...
    $(document).ready(function()
    {
        ...
        $('#select_branch').on('change',function () 
        {
            ...
            if(branch)
            {
                $.ajax({
                    'type':'POST',
                    'url':"<?php echo e(Route('view.select.branch')); ?>",
                    'data':
                    {
                        'branch'  : branch,
    ...
    $(document).ready(function()
    {
        ...
        $('#select_menu').on('change',function () 
        {
            ...
            if(branch)
            {
                $.ajax({
                    'type':'POST',
                    'url':"<?php echo e(Route('view.select.menu')); ?>",
                    'data':
                    {
                        branch : branch,
                        menu   : menu,
...
<?php /**PATH F:\BackEnd\htdocs\webpoint\resources\views/includes/control/main.blade.php ENDPATH**/ ?>