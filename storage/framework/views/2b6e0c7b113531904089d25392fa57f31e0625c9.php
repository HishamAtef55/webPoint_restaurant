...
<?php $__env->startSection('content'); ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-md-3 d-flex flex-column">
                    <button class="btn-report-in-day btn btn-success my-2" id="cashier_report">Cashier Report</button>
                    <button class="btn-report-sold-in-day btn btn-success my-2" id="cashier_sold">Cashier Sold Items</button>
                    <button class="btn-report-in-day btn btn-success my-2" id="busy_order">Busy Order</button>
                    <button class="btn-report-sold-in-day btn btn-success my-2" id="busy_sold">Busy Sold Item</button>
                </div>
            </div>
          </div>
        </div>
    ...
    <?php echo $__env->make('includes.reports.sales_current_reports', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webpoint\resources\views/Reports/sales_current_report.blade.php ENDPATH**/ ?>