...
$(document).ready(function() {
    ...
    /*  ======================== Start limit Min Report ============================== */
        sections.on('change', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('inventoryDaily.getMaterials')); ?>",
                method: 'post',
                data: {
                    _token,
    ...
    saveInventoryBtn.on('click', function() {
        $.ajax({
            url: "<?php echo e(route('inventoryDaily.storeInventory')); ?>",
            method:'post',
...
<?php /**PATH E:\MyWork\Res\webPoint\resources\views/includes/stock/reports_ajax/inventory_daily.blade.php ENDPATH**/ ?>