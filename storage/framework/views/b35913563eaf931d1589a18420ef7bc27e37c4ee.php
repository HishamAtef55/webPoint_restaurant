...
$(document).ready(function() {
    ...
    /*  ======================== Start limit Min Report ============================== */
        sections.on('change', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('inventory.getMaterials')); ?>",
                method: 'post',
                data: {
                    _token,
    ...
    saveInventoryBtn.on('click', function() {
        $.ajax({
            url: "<?php echo e(route('inventory.storeInventory')); ?>",
            method:'post',
...
<?php /**PATH E:\MyWork\Res\webPoint\resources\views/includes/stock/reports_ajax/inventory.blade.php ENDPATH**/ ?>