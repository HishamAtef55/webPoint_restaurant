...
<?php $__env->startSection('content'); ?>
    ...
    <section class='check-out px-4'>
        ...
        <div class="container py-5">
            ...
            <div class="waiter" id="report-output">
            </div>
        </div>
    </section>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-md-3 d-flex flex-column">
                    <button class="btn-report-in-day btn btn-success my-2" id="waiter_report">View Report</button>
                </div>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\MyWork\Res\webPoint\resources\views/Reports/waiter_sales.blade.php ENDPATH**/ ?>