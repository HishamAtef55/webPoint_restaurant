...
<script>
    ...
    $('#save_store').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('save.store')); ?>",
            method: 'post',
            data: {
                _token,
                name: name.val(),
    ...
    $('#update_store').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('update.store')); ?>",
            method: 'post',
            data: {
                _token,
                id: id.val(),
...
</script><?php /**PATH C:\xampp\htdocs\web_point\resources\views/includes/stock/Stock_Ajax/stores.blade.php ENDPATH**/ ?>