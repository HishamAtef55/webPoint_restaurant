            ...
            <div class="col-lg-10 offset-lg-1 col-md-12">
                ...
                <div class="table-responsive">
                    <table id="editable" class="table table-bordered table-striped" font_Size="15">
                        ...
                        <tbody id="tbody">
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ex): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="<?php echo e($ex->id); ?>">
                                    <td>
                                        <span class="tabledit-span tabledit-identifier"><?php echo e($ex->id); ?></span>
                                        <input id="id" class="tabledit-input tabledit-identifier" type="hidden" name="id" value="<?php echo e($ex->id); ?>">
                                    </td>
                                    
                                    <td class="">
                                        <span class="tabledit-span tabledit-identifier"><?php echo e($ex->branch->name); ?></span>
                                        <input id="branch_id" class="tabledit-input tabledit-identifier" type="hidden" name="branch_id" value="<?php echo e($ex->branch->name); ?>">
                                    </td>

                                    <td class="tabledit-edit-mode">
                                        <span class="tabledit-span tabledit-identifier"><?php echo e($ex->title); ?></span>
                                        <input type="text" style="display: none;" disabled class="tabledit-input form-control input-sm" name="name" value="<?php echo e($ex->title); ?>">
                                    </td>
...
<?php echo $__env->make('includes.control.Expenses', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webpoint\resources\views/control/Expenses.blade.php ENDPATH**/ ?>