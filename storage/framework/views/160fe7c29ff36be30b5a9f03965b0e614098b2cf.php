...
<script>
    $(document).ready(function() {
        ...
        function getItems(branchVal, itemsDiv) {
            $.ajax({
                url: "<?php echo e(route('components_items_get_items')); ?>",
                method: 'post',
                data: {
                    _token,
                    branch: branchVal,
        ...
        items.on('change', function() {
            ...
            materialArray = [];
            $.ajax({
                url: "<?php echo e(route('components_items_get_material_in_item')); ?>",
                method: 'post',
                data: {
                    _token,
                    item: items.val(),
        ...
        saveComponent.on('click', function() {
            $.ajax({
                url: "<?php echo e(route('saveComponent')); ?>",
                method: 'post',
                data: {
                    _token,
                    branch: branch.val(),
        ...
        itemWithOutMaterials.on('click', function() {
            let title = $(this).text();
            $.ajax({
                url: "<?php echo e(route('itemsWithOutMaterials')); ?>",
                method: 'post',
                data: {
                    _token,
                    branch: branch.val()
        ...
        componentWithoutItems.on('click', function() {
            let title = $(this).text();
            $.ajax({
                url: "<?php echo e(route('componentWithoutItems')); ?>",
                method: 'post',
                data: {
                    _token,
                    branch: branch.val()
        ...
        printComponent.on('click', function() {
            let title = $(this).text();
            $.ajax({
                url: "<?php echo e(route('printComponent')); ?>",
                method: 'post',
                data: {
                    _token,
                    branch: branch.val(),
        ...
        printItem.on('click', function() {
            let title = $(this).text();
            $.ajax({
                url: "<?php echo e(route('printItems')); ?>",
                method: 'post',
                data: {
                    _token,
                    branch: branch.val(),
        ...
        */
        ...
        $('#save_transfer').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('transferMaterial')); ?>",
                method: 'post',
                data: {
                    _token,
        ...
        */
        ...
        $('#search_component_details').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('printComponents')); ?>",
                method: 'post',
                data: {
                    _token,
                    branch: componentsBranch.val(),
...
</script><?php /**PATH C:\xampp\htdocs\web_point\resources\views/includes/stock/Stock_Ajax/component_items.blade.php ENDPATH**/ ?>