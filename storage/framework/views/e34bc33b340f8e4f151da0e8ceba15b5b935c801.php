<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#editable').Tabledit({
            url:'<?php echo e(route("tablebranch.action")); ?>',
            dataType:"json",
            columns:{
                identifier:[0, 'id'],
                editable:[[1, 'name']],
    ...
    $(document).on('click','#save_branch',function (e)
    {
        ...
        e.preventDefault();
        $.ajax({
        url: "<?php echo e(route('add.branch')); ?>",
        method: 'post',
...
<?php /**PATH F:\BackEnd\htdocs\webpoint\resources\views/includes/control/branch.blade.php ENDPATH**/ ?>