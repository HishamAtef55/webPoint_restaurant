...
<script>
    ...
    $(document).ready(function() {
        ...
        showTransferReport.on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('reports.purchases.report')); ?>",
                method: 'post',
                data: {
                    _token,
                    type,
...
<?php /**PATH C:\xampp\htdocs\web_point\resources\views/includes/stock/reports_ajax/purchases.blade.php ENDPATH**/ ?>