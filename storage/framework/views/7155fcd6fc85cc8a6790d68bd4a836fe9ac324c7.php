...
mainMaterial.on('change', function() {
    ...
    materialArray = [];
    $.ajax({
        url: "<?php echo e(route('getRecipeMaterialInMaterials')); ?>",
        method: 'post',
        data: {
            _token,
...
$(document).on('click', '.delete_Component', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            calcPricePercent();
            $.ajax({
                url: "<?php echo e(route('deleteMaterialRecipe')); ?>",
                method: 'post',
                data: {
                    _token,
...
saveComponent.on('click', function() {
    $.ajax({
        url: "<?php echo e(route('saveMaterialRecipe')); ?>",
        method: 'post',
        data: {
            _token,
            material: mainMaterial.val(),
...
printComponents.on('click', function() {
    $.ajax({
        url: "<?php echo e(route('getMaterialsReports')); ?>",
        method: 'post',
        data: {
            _token,
        },
...
printComponent.on('click', function() {
    let title = $(this).text();
    $.ajax({
        url: "<?php echo e(route('getMaterialReports')); ?>",
        method: 'post',
        data: {
            _token,
            material :mainMaterial.val(),
...
$('#save_transfer').on('click', function() {
    ...
    $.ajax({
        url: "<?php echo e(route('transferMaterialRecipe')); ?>",
        method: 'post',
        data: {
            _token,
...
<?php /**PATH C:\xampp\htdocs\web_point\resources\views/includes/stock/Stock_Ajax/material_recipe.blade.php ENDPATH**/ ?>