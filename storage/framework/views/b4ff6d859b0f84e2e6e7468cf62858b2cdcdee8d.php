                            ...
                            <div class='radios mt-3 mb-3'>
                                ...
                                <div class='radio-box p-3 shadow'>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="position" id="<?php echo e($job->id); ?>"
                                            value="<?php echo e($job->id); ?>">
                                        <label class="form-check-label" for="<?php echo e($job->id); ?>"><?php echo e($job->name); ?></label>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('includes.control.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\BackEnd\htdocs\webpoint\resources\views/control/update_user.blade.php ENDPATH**/ ?>