...
$(document).on('click','#save_other',function (e)
{
    ...
    e.preventDefault();
    $.ajax({
        url:"<?php echo e(route('save.other')); ?>",
        method:'post',
...
$(document).ready(function()
    {
        ...
        $('#select_branch').on('change',function ()
        {
            ...
            if(branch)
            {
                $.ajax({
                    'type':'POST',
                    'url':"<?php echo e(Route('get.other')); ?>",
                    'data':
                    {
                        'branch'  : branch,
...
<?php /**PATH C:\xampp\htdocs\webpoint\resources\views/includes/control/other.blade.php ENDPATH**/ ?>