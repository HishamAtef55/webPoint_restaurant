...
$(document).on('click','#save_services_tables',function (e)
{
    ...
    e.preventDefault();
    $.ajax({
        url:"<?php echo e(route('save.ser.table')); ?>",
        method:'post',
...
$(document).ready(function()
    {
        ...
        $('#select_branch').on('change',function ()
        {
            ...
            if(branch)
            {
                $.ajax({
                    'type':'POST',
                    'url':"<?php echo e(Route('get.ser.table')); ?>",
                    'data':
                    {
                        'branch'  : branch,
...
<?php /**PATH C:\xampp\htdocs\webpoint\resources\views/includes/control/services_tables.blade.php ENDPATH**/ ?>