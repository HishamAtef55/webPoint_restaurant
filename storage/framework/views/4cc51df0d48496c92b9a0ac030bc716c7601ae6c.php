    ...
    <div class="container">
        <div class="bg-light p-4 mb-2 rounded shadow">
            ...
            <div class="row">
                ...
                <div class="col">
                    <button class="btn btn-primary showTransferReport" data-request="details">عرض</button>
                    <button class="btn btn-warning showTransferReport" data-request="total">عرض اجمالي</button>
                </div>
            </div>
            <hr />
...
<?php echo $__env->make('includes.stock.reports_ajax.manufacturing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.stock.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\MyWork\Res\webPoint\resources\views/stock/reports/manufacturing.blade.php ENDPATH**/ ?>