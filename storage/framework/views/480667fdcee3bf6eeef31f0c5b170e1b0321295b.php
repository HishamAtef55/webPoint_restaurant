...
$(document).ready(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (rowParent.hasClass('new')) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('deleteItemExchange')); ?>",
                        method: 'post',
                        data: {
                            _token,
                            rowId,
    ...
    $(document).on('click', '.update_unite', function() {
        ...
        if (rowParent.hasClass('old')) {
            $.ajax({
                url: "<?php echo e(route('updateItemExchange')); ?>",
                method: 'post',
                data: {
                    _token,
                    rowId,
    ...
    saveBtn.on('click', function() {
        $.ajax({
            url: "<?php echo e(route('saveExchange')); ?>",
            method:'post',
    ...
    updateBtn.on('click', function() {
        $.ajax({
            url: "<?php echo e(route('updateExchange')); ?>",
            method:'post',
            enctype:"multipart/form-data",
            processData:false,
            cache : false,
    ...
    deleteBtn.on('click', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo e(route('deleteExchange')); ?>",
                    method: 'post',
                    data: {
                        _token,
                        permission: permission.val()
    ...
    permission.on('change', function() {
        $.ajax({
            url: "<?php echo e(route('getExchange')); ?>",
            method: 'post',
            data: {
                _token,
                permission: permission.val(),
    ...
    seriesNumber.on('change', function() {
        $.ajax({
            url: "<?php echo e(route('getExchangeViaSerial')); ?>",
            method: 'post',
            data: {
                _token,
    ...
    orderNumber.on('change',function (){
        $.ajax({
            url: "<?php echo e(route('getExchangeViaOrder')); ?>",
            method: 'post',
            data: {
                _token,
...
<?php /**PATH C:\xampp\htdocs\web_point\resources\views/includes/stock/Stock_Ajax/exchange.blade.php ENDPATH**/ ?>