...
$(document).ready(function(){
    $('#search_main_table').on('change',function () {
        ...
        let ID = $('#search_main_table').val();
            $('#tbody').show();
            $.ajax({
                url:"<?php echo e(route('search.main.table')); ?>",
                method:'post',
                data:
                {
                    ID     :ID,
...
$(document).ready(function(){
    $('#search_new_table').on('change',function () {
        ...
        $.ajax({
            url:"<?php echo e(route('search.new.table')); ?>",
            method:'post',
            data:
            {
                ID     :ID,
    ...
    $(document).ready(function(){
        $('#transfer').on('click',function (e) {
            ...
            $.ajax({
                url:"<?php echo e(route('move.to.item')); ?>",
                method:'post',
                data:
                {
                    _token           :_token,
...
<?php /**PATH E:\MyWork\Res\webPoint\resources\views/includes/menu/move_to.blade.php ENDPATH**/ ?>