...
<script>
    ...
    $(document).ready(function() {
        ...
        showTransferReport.on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('reports.manufacturing.report')); ?>",
                method: 'post',
                data: {
                    _token,
                    reportType,
...
</script><?php /**PATH E:\MyWork\Res\webPoint\resources\views/includes/stock/reports_ajax/manufacturing.blade.php ENDPATH**/ ?>