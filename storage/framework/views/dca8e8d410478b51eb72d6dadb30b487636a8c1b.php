...
$(document).on('click','#save_user',function (e) {
    ...
    $(document).ready(function(){
        ...
        $('#editable').Tabledit({
            url:'<?php echo e(route("tableuser.action")); ?>',
            dataType:"json",
            columns:{
                identifier:[[0, 'id']],
    ...
    $(document).ready(function(){
        $('#search').keyup(function ()
        {
            ...
            if(query != '')
            {
                ...
                $.ajax({
                    url:"<?php echo e(route('search.user')); ?>",
                    method:'post',
                    enctype:"multipart/form-data",
...
<?php /**PATH F:\BackEnd\htdocs\webpoint\resources\views/includes/control/user.blade.php ENDPATH**/ ?>