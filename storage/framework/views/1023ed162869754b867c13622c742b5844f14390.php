<script>
    ...
    $(document).ready(function ()
    {
        $('#select').on('change',function ()
        {
            ...
            if(branchID)
            {
                $.ajax({
                   'type':'POST',
                   'url':"<?php echo e(Route('item.detalis')); ?>",
                    'data':
                        {
    ...
    $(document).ready(function ()
    {
        $('#select_data').on('change',function ()
        {
            ...
            if(item_id)
            {
                $.ajax({
                   'type':'POST',
                   'url':"<?php echo e(Route('extract.details.table')); ?>",
                    'data':
                        {
                            '_token': "<?php echo e(csrf_token()); ?>",
                            'select': item_id,
    ...
    $(document).ready(function(){
        $('#details-name').keyup(function ()
        {
            ...
            {
                $.ajax({
                    url:"<?php echo e(route('Search.item.details')); ?>",
                    method:'post',
    ...
    $(document).on('click','#save_new_details',function (e)
    {
        ...
        $.ajax({
            url: "<?php echo e(route('save.details')); ?>",
            method: 'post',
    ...
    $(document).on('click', '#add_to_table', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('export.details')); ?>",
            method: 'post',
            data:
            {
                _token           : _token,
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.row_table_update', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('update.dettails.price')); ?>",
                method: 'post',
                data:
                {
                    _token           : _token,
        ...
        let route      ='update.dettails.price';
        $.ajax({
            url: "<?php echo e(route('delete.item.details')); ?>",
            method: 'post',
            data:
            {
                _token           : _token,
...
<?php /**PATH C:\xampp\htdocs\web_point\resources\views/includes/control/add_itemdetals_ajax.blade.php ENDPATH**/ ?>