...
class CreateWaitOrdersMTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wait_orders_m', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('order_id')->nullable();
            $table->string('state', 5)->default('0');
            $table->integer('item_id')->default(0);
            $table->string('d_order')->default(0);
    ...
    {
        Schema::dropIfExists('wait_orders_m');
    }
}
