...
class StockController extends Controller
{
    ...
    {
        $statement  = DB::select("SHOW TABLE STATUS LIKE 'stock_stores'");
    ...
    public function view_Store()
    {
        ...
        $stores = Stores::get();
        return view('stock.Stores.Addstore', compact(['new_store', 'stores']));
    }
    ...
    public function editStore(
        ...
        $store = Stores::with('storgecapacity')->findOrFail($id);
        $stores = Stores::get();
        return view('stock.Stores.editStore', [
            'store' => $store,
            'stores' => $stores
        ]);
    }
    ...
    public function viewStore(
        ...
        $store = Stores::with('storgecapacity')->findOrFail($id);
        $stores = Stores::get();
        return view('stock.Stores.viewStore', [
            'store' => $store,
            'stores' => $stores
        ]);
    }
