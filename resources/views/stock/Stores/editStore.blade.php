            ...
            <div class="row">
                <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="custom-form position-relative">
                                    <input type="text" name="store_name" value="{{ $store->name }}" id="store_name">
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="custom-form">
                                    <input type="text" name="store_phone" value="{{ $store->phone }}" id="store_phone">
                                    <label for="store_phone">تليفون</label>
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="custom-form">
                                    <input type="text" name="store_address" value="{{ $store->address }}"
                                        id="store_address">
                    ...
                    <div class="d-grid gap-2 mx-auto mt-4">
                        <button class='btn btn-primary' id="update_store">Update</button>
                    </div>
                </div>
                <div class="col-md-6">
