            ...
            <div class="container">
                <ul class="list-unstyled p-3">
                    <li class="@if(Route::current()->getName() == 'view.stores') active @endif">
                        <a class="text-muted py-1 d-block" href="{{route('view.stores')}}"> المخازن </a>
                    </li>
                    <li class="@if(Route::current()->getName() == 'view.section') active @endif">
                        <a class="text-muted py-1 d-block" href="{{route('view.section')}}"> الاقسام </a>
                    </li>
                    ...
                    <li class="@if(Route::current()->getName() == 'view.main_groups') active @endif">
                        <a class="text-muted py-1 d-block" href="{{route('view.main_groups')}}"> المجموعات الرئيسية </a>
                    </li>
                    <li class="@if(Route::current()->getName() == 'view.groups') active @endif">
                        <a class="text-muted py-1 d-block" href="{{route('view.groups')}}"> المجموعات الفرعية </a>
                    </li>
                    ...
                    <li class="@if(Route::current()->getName() == 'view_components_items') active @endif">
                        <a class="text-muted py-1 d-block" href="{{Route('view_components_items')}}"> مكونات الاصناف </a>
                    </li>
                    <li class="@if(Route::current()->getName() == 'componentDetailsItem') active @endif">
                        <a class="text-muted py-1 d-block" href="{{route('componentDetailsItem')}}"> مكونات تفاصيل الاصناف </a>
                    </li>
