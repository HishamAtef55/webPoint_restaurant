        ...
        $('#select').on('change', function() {
            ...
            $.ajax({
                ...
                success:function(data) {
                    ...
                    $('.res-image').html(`<label for="res-image" class="image" data-label="Resturant Image" style="background-image:url({{ URL::asset('control/images/information') }}/${data.information.image})"></label>`);
                    $('.slogan-image').html(`<label for="slogan-image" class="image" data-label="Slogan Image" style="background-image:url({{ URL::asset('control/images/information') }}/${data.information.slogan})"></label>`);
