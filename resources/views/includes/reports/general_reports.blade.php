<script>
    ...
    $(document).on('click','#waiter_report',function (e) {
        ...
        $.ajax({
            url:"{{route('search_water_sales_report')}}",
            method: 'post',
    ...
    $(document).on('click','#shift_report',function (e) {
        ...
        $.ajax({
            url:"{{route('search_shift_sales_report')}}",
            method: 'post',
            enctype: "multipart/form-data",
            data:
                {
    ...
    $(document).on('click','#transfer_report',function (e) {
        ...
        $.ajax({
            url:"{{route('search_transfer_report')}}",
            method: 'post',
            enctype: "multipart/form-data",
            data:{
                _token,
    ...
    $(document).on('click','#discount_report',function (e) {
        ...
        $.ajax({
            url:"{{route('search_discount_report')}}",
            method: 'post',
            enctype: "multipart/form-data",
            data:
                {
    ...
    $(document).on('click','#expenses_report',function (e) {
        ...
        $.ajax({
            url:"{{route('search_expenses_report')}}",
            method: 'post',
            enctype: "multipart/form-data",
            data:
                {
