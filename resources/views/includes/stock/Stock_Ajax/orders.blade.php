...
$(document).ready(function() {
    ...
    deleteBtn.on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{route('stock.orders.destroy')}}",
                    method: 'post',
                    data: {
                        _token,
                        type,
    ...
    permission.on('change', function() {
        ...
        $.ajax({
            url: "{{route('stock.orders.getData')}}",
            method: 'post',
            data: {
                _token,
                type,
