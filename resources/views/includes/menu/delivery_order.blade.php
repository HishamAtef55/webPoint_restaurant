<script>
    ...
    $(document).ready(function() {
                    ...
                    for (var count = 0; count < data.length; count++) {
                        ...
                        if (page == "to_pilot") {
                            ...
                            html += `
                                        @Can("edite delivery")
                                        <li>
                                            <a href="{{url('menu/Edit_Delivery/${data[count].order_id}')}}">
        ...
        $('#select_pilot').on('change', function() {
            ...
            let page = $('#check_page').attr('value');
            $.ajax({
                url: "{{route('Search.pilot.delivery')}}",
                method: 'post',
                data: {
                    query: query,
                    _token: _token,
                ...
                success: function(data) {
                    ...
                    for (var count = 0; count < data.length; count++) {
                        ...
                        if (page == "to_pilot") {
                            html += `<ul>`
                            html += `@can("add pilot")<li data-toggle="modal" data-target="#pilot">
                                            <a href="#">
                                                <i class="fas fa-biking fa-fw"></i>
                                                <span>Pilot</span>
                                            </a>`
                            ...
                            html += `@can("remove delivery")<li id="Remove_Delivery" class='remove'>
                                            <a href="#">
                                                <i class="fas fa-trash-alt fa-fw"></i>
                                                <span>Remove</span>
                                            </a>`
                            ...
                            html += `<ul>`
                            html += `@can("change pilot")<li data-toggle="modal" data-target="#pilot">
                                            <a href="#">
                                                <i class="fas fa-biking fa-fw"></i>
                                                <span>Change Pilot</span>
                                            </a>`
                            ...
                            html += `@can("pay check delivery")<li class='done'>
                                            <a href="#">
                                                <i class="fas fa-check fa-fw"></i>
                                                <span> Pay </span>
                                            </a>`
                            html += `</li>@endcan`
                            html += `@can("print check delivery")<li>
                                            <a href="#">
                                                <i class="fas fa-print fa-fw"></i>
                                                <span class="secoundprint"> Print </span>
                                            </a>`
