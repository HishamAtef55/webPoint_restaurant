<script>
    ...
    // ######################   End Delete Discount Order  #######################################

    // ###################### Start Save Disount All #############################################
    ...
    // ############################### Start Chnge Services And Tax In Check Footer ###################################
    ...
    //  ############################## End End Table ###############################
    //  ############################## Start TakeOrder & Pay Butons In ToGO ###############################
    $("document").ready(function() {
        let holdCheck = $('#check_hold').attr('value');
        let operation = $('#operation').attr('value');
    ...
    //  ############################## End TakeOrder & Pay Butons In ToGO ###############################
</script>
