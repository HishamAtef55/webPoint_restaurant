          ...
          <div class="modal-content">
            ...
            <div class="modal-body row">
                <div class="col-md-9">
                    <form>
                        ...
                        <div class="select-container">
                            ...
                            <select id="transfer" class="custom-select select-report">
                                <option value="Move-To">Move-To</option>
                                <option value="Transfer">Transfer-Table</option>
                            </select>
                        </div>
                ...
                <div class="col-md-3 d-flex flex-column">
                    <button class="btn-report-in-day btn btn-success my-2" id="transfer_report">View Report</button>
                </div>
            </div>
          </div>
        </div>
