            ...
            <div class="modal-body row">
                <div class="col-md-9">
                    ...
                    <div class="select-container">
                        ...
                        <input type="date" class="form-control select-report" id="from" value="<?php echo date('Y-m-d',strtotime("0 days"));?>"  max="<?php echo date('Y-m-d',strtotime("0-1 days"));?>" dataformatas="dd/mm/yyyy">
                    </div>
                    <div class="select-container">
                            ...
                            <div class="collapse" id='shift'>
                                <div class="d-flex pl-3">
                                    ...
                                    <div class="form-group m-0">
                                        <input type="checkbox" id="shift{{$shift->shiftid}}" name="Shift" class="check-shift" value="{{$shift->shiftid}}">
                ...
                <div class="col-md-3 d-flex flex-column">
                    <button class="btn-report-in-day btn btn-success my-2" id="shift_report">View Report</button>
                </div>
            </div>
          </div>
        </div>
